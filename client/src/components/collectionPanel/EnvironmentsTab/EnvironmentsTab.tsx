...
const EnvironmentTab: FunctionComponent<EnvironmentModalProps> = ({
  ...
  async function handleCreateEnvClicked() {
    ...
    try {
      ...
      successToast('环境已创建', toast);
    } catch (e) {
      errorToast('环境创建失败', toast);
    }
  }
  ...
  async function handleDeleteEnvClicked() {
    try {
      ...
      successToast('环境已删除', toast);
    } catch (e) {
      errorToast('环境删除失败', toast);
    }
  }
  ...
  async function handleCreateSecretClicked() {
    try {
      ...
      successToast('密钥已创建', toast);
    } catch (e) {
      errorToast('密钥创建失败', toast);
    }
  }
  ...
  async function handleSaveSecretClicked(i: number) {
    try {
      ...
      setSecret(i, secret);
      successToast('密钥已保存', toast);
    } catch (e) {
      errorToast('密钥设置失败', toast);
    }
  }
  ...
  async function handleDeleteSecretClicked(i: number) {
    try {
      ...
      deleteSecret(i);
      successToast('密钥已删除', toast);
    } catch (e) {
      errorToast('密钥删除失败', toast);
    }
  }
